...
class _DependenciesData {
  _DependenciesData({required this.list, required this.usedDependencies});
...
abstract class DependenciesLintBase extends RiverpodLintRule {
  ...
  @override
  List<DartFix> getFixes() => [_DependenciesFix()];
}

class _DependenciesFix extends RiverpodFix {
